    ...
    <div className="w-full mx-auto mb-10">
      <div className="flex flex-col justify-center items-center h-full">
        <div className="flex items-center gap-2 config mt-5 mb-3">
          <span>Config: </span>
          <input className='border p-2 rounded' type="text" onChange={(e) => setUser(e.target.value)} value={user} placeholder='User'/>
          <input className='border p-2 rounded' type="text" onChange={(e) => setFriend(e.target.value)} value={friend} placeholder='Friend'/>
        </div>
        ...
        <div className='flex gap-2'>
          <input className='border p-2 rounded' type="text" onChange={handleChange} value={val}/>
          ...
          <button onClick={connectToServer} className='hover:scale-105 transition-transform ease-in-out duration-100 p-2 rounded bg-green-600 text-white cursor-pointer'>Connect</button>
